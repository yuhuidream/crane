...
#include "qspinlock.h"                    /* added for Multi-core extension */
/****************************************************************************/
...
typedef struct QEvtTag {
    ...
    void    *tgt;         /** extra pointer, here use it to indicate which 
                          * component the event is posted to 
                          */

#ifdef CONFIG_SMP                         /* added for Multi-core extension */
    QSpinlock refCtrLock_;
#endif

#ifdef MULTI_UART
    uint8_t uart_id_;                     /* uart channel id*/
#endif
...
#ifdef CONFIG_SMP
#define QEVT_SMP_INIT ,Q_SPIN_LOCK_INITIALIZER
#else
#define QEVT_SMP_INIT
#endif

#ifdef Q_SPY
#define QEVT_SPY_INIT ,0
#else
#define QEVT_SPY_INIT
#endif

#define QEVT_EXTRA_INIT , (void *)0 QEVT_SMP_INIT QEVT_SPY_INIT \

#define QEVT_INIT(sig, poolId_, refCtr_) {sig, poolId_, refCtr_  QEVT_EXTRA_INIT}
