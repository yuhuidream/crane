...
#ifdef Q_SPY_EXT
    uint8_t index;                  /**< index for multi-sm filter */
#endif
} QMsm;
...
enum QReservedSignals {
    ...
    Q_WAKE_SIG,               /**< signal for waking a suspended AO or Comp */
    Q_RETURN_SIG,            /**< signal for returning a borrowed Component */
    Q_VTE_SIG,              /**< signal after which can be valid time event */
    QA_LRAB_SIG,                          /**< signal for breaking long RTC */
    QA_SLEEP_SIG,                         /**< signal to wake up a sleep AO */
