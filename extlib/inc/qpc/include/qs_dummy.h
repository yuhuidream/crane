...
#ifdef Q_SPY_EXT
#define QS_BEGIN_AO_(rec_, objFilter_, pri)  if (0) {
#define QS_BEGIN_SM_(rec_, objFilter_, index)  if (0) {
#endif
#define QS_END_()                       }
#define QS_BEGIN_NOCRIT_(rec_, refObj_, obj_) if (0) {
#ifdef Q_SPY_EXT
#define QS_BEGIN_NOCRIT_AO_(rec_, objFilter_, pri)  if (0) {
#define QS_BEGIN_NOCRIT_SM_(rec_, objFilter_, index)  if (0) {
#endif
