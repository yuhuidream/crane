...
)
{
    ...
    ******************************************************************************/
    next = 0;
    USB_dev_memzero(struct_to_link_list, MAX_ITD_DESCRS * sizeof(uint_32));
    ...
    *******************************************************************************/
    ...
    for (i = 0; i < no_of_itds; i++)
    {
        ...
        **********************************************************************/
        USB_dev_memzero((uchar_ptr)ITD_ptr, 16 * sizeof(uint_32));
...
)
{
    ...
    ******************************************************************************/
    next = 0;
    USB_dev_memzero(struct_to_link_list, MAX_SITD_DESCRS * sizeof(uint_32));
    ...
    *******************************************************************************/
    ...
    for (i = 0; i < no_of_sitds; i++)
    {
        ...
        **********************************************************************/
        ...
        defined by EHCI specs). Fill the necessary fields.
        **********************************************************************/
        USB_dev_memzero((pointer)SITD_ptr, 7 * sizeof(uint_32));
