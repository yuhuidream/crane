 ...
 */
#ifdef MRVL_PMU
//static unsigned int event_type[4]={PMU_DCACHE_READ_HIT, PMU_DCACHE_READ_MISS, PMU_L2CACHE_READ_HIT, PMU_L2CACHE_READ_MISS};
static unsigned int event_type[4]={PMU_DCACHE_WRITE_HIT, PMU_DCACHE_WRITE_MISS, PMU_L2CACHE_WRITE_HIT, PMU_L2CACHE_WRITE_MISS};
//static unsigned int event_type[4]={PMU_INSTRUCTION_EXECUTED, PMU_BRANCH_MISPREDICT, PMU_MMU_BUSREQUEST, PMU_ICACHE_BUS_REQUEST};
//static unsigned int event_type[4]={PMU_WB_LATENCY, PMU_LDMSTM_HOLD, PMU_LDST_ROB0_ONHOLD, PMU_LDST_ROB1_ONHOLD};
//static unsigned int event_type[4]={PMU_DATA_WRITE_ACCESS, PMU_DATA_READ_ACCESS, PMU_A2_STALL, PMU_ICACHE_READ_MISS};
//static unsigned int event_type[4]={PMU_ITLB_MISS, PMU_DTLB_MISS, PMU_MAIN_ITLB_MISS, PMU_MAIN_DTLB_MISS};
//static unsigned int event_type[4]={PMU_SINGLE_ISSUE, PMU_DUAL_ISSUE, PMU_BRANCH_RETIRED, PMU_ROB_FULL};
//static unsigned int event_type[4]={PMU_HOLD_IS, PMU_L2C_LATENCY, PMU_DCACHE_ACCESS, PMU_A1_STALL};
//static unsigned int event_type[4]={PMU_DCACHE_READ_LATENCY, PMU_DCACHE_WRITE_LATENCY, PMU_L2CWB_FULL, PMU_WB_FULL};
//static unsigned int event_type[4]={PMU_DCACHE_READ_BEAT, PMU_DCACHE_WRITE_BEAT, PMU_BIU_ACCESS, PMU_ICACHE_READ_BEAT};
