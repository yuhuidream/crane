...
extern void reset_CCNT(void);
extern void reset_PMU(void);
extern unsigned int read_PMCNT(unsigned int);
extern void disable_counters(void);
extern void enable_counters(void);
extern void enable_overflow_flag(void);
extern void enable_interrupt(void);
extern void set_counter_divider(unsigned int);
extern unsigned int read_CCNT(void);
