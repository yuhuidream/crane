...
int row;
{
   DBG_PRINT(ON_OFF,"%11.4f%11.4f%11.4f%11.0f%11.4f%11.4f\n\r",   (double)time[0][row],
...
linpack_main ()
{
   ...
   DBG_PRINT(ON_OFF,ROLLING);DBG_PRINT(ON_OFF,PREC);DBG_PRINT(ON_OFF,"Precision Linpack\n\r\n\r");
   //DBG_PRINT(ON_OFF,ROLLING);DBG_PRINT(ON_OFF,PREC);DBG_PRINT(ON_OFF,"Precision Linpack\n\r\n\r");
   total_time = second();
...
/*     compute a residual to verify results.  */ 
   ...
   DBG_PRINT(ON_OFF,"     norm. resid      resid           machep");
   DBG_PRINT(ON_OFF,"         x[0]-1        x[n-1]-1\n\r");
   DBG_PRINT(ON_OFF,"  %8.1f      %16.8e%16.8e%16.8e%16.8e\n\r",
          (double)residn, (double)resid, (double)eps, 
               (double)x[0]-1, (double)x[n-1]-1);

   DBG_PRINT(ON_OFF,"    times are reported for matrices of order %5d\n\r",n);
   DBG_PRINT(ON_OFF,"      dgefa      dgesl      total       kflops     unit");
   DBG_PRINT(ON_OFF,"      ratio\n\r");
   ...
   DBG_PRINT(ON_OFF," times for array with leading dimension of%5d\n\r",lda);
   print_time(0);
   ...
   DBG_PRINT(ON_OFF," times for array with leading dimension of%4d\n\r",ldaa);
   total_time = second() - total_time;
   print_time(4);
   print_time(5);
   print_time(6);
   print_time(7);
   DBG_PRINT(ON_OFF,ROLLING);DBG_PRINT(ON_OFF,PREC);
   DBG_PRINT(ON_OFF,"Precision %5d Kflops (%.2f Mflops); %d Reps;"
