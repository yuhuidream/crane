...
#BBU have different configuration, define options for different test scenario
#e.g. MINI config for fast normal debug,  AUTO for automatic screen test
# PE config for operations chip test on Chroma, HW config for board test at HW team

BBU_CONF := $(or $(BBU_CONF),MINI)
