#ifndef __SD_v_3_1_H__
#define __SD_v_3_1_H__
...
typedef struct
{
    ...
    __IO uint32_t SDHC_SLOT_STROBE_DLY_CTRL      ; /* 0x0140 SDHC Slot Strobe Delay Control Register */  
    ...
    __IO uint32_t EMMC_PHY_TIMING_ADJUST         ; /* 0x0160 eMMC PHY Timing Adjust */
    __IO uint32_t EMMC_PHY_FUNC_ONTROL           ; /* 0x0164 eMMC PHY Func Control */
    __IO uint32_t EMMC_PHY_PAD_CONTROL           ; /* 0x0168 eMMC PHY Pad Control */
    __IO uint32_t EMMC_PHY_PAD_CONTROL2          ; /* 0x016C eMMC PHY Pad Control 2 */
    __IO uint32_t EMMC_PHY_DLL_CONTROL            ; /* 0x0170 eMMC PHY DLL Control */
    __IO uint32_t EMMC_LOGIC_TIMING_ADJUST       ; /* 0x0174 eMMC Logic Timing Adjust */
    __IO uint32_t PHY_LB_FUNC_CONFIG             ; /* 0x0178 eMMC PHY Loopback Func Config */
    __IO uint32_t PHY_LB_DATA_PATTERN            ; /* 0x017C eMMC PHY Loopback Data Pattern */
    __IO uint32_t PHY_LB_FUNC_CONTROL            ; /* 0x0180 eMMC PHY Loopback Func Control */
    __IO uint32_t PHY_LB_ERR_STATUS              ; /* 0x0184 eMMC PHY Loopback Err Status */
    __IO uint32_t PHY_LB_COMP_CNT                ; /* 0x0188 eMMC PHY Loopback Comparison Count */
  
}SD_v3_1_TypeDef;


#define    SD3_BASE      0xD4290000
#define    SD3  (( SD_v3_1_TypeDef *) SD3_BASE )
...
#define EMMC_PHY_PAD_CONTROL_FC_QSN_PU                      BIT_23              /* QSN Pullup Enable */
#define EMMC_PHY_PAD_CONTROL_FC_QSP_PU                      BIT_22              /* QSP Pullup Enable */
#define EMMC_PHY_PAD_CONTROL_FC_CMD_PU                      BIT_21              /* CMD Pullup Enable */
#define EMMC_PHY_PAD_CONTROL_FC_DQ_PU                       BIT_20              /* DQ Pullup Enable */
#define EMMC_PHY_PAD_CONTROL_FC_QSN_PD                      BIT_19              /* QSN Pulldown Enable */
#define EMMC_PHY_PAD_CONTROL_FC_QSP_PD                      BIT_18              /* QSP Pulldown Enable */
#define EMMC_PHY_PAD_CONTROL_FC_CMD_PD                      BIT_17              /* CMD Pulldown Enable */
#define EMMC_PHY_PAD_CONTROL_FC_DQ_PD                       BIT_16              /* DQ Pulldown Enable */
...
/* DLL Update Strobe */
#define EMMC_PHY_DLL_CONTROL_DLL_UPDATE_STROBE                  BIT_30              
