...
#define  BSP_VUSB20_HOST_BASE_ADDRESS0     USB_SPH_BASE//USB_SPH_BASE//(USB_SPH_BASE+0x100)//+0x40)// (USB_OTG_BASE+0x100) //(0xd4208100)	//(0xFC5100)
...
#define USB_memalloc(bufferlen)  bbu_vm_malloc(bufferlen,NON_CACHEABLE)
#define USB_Uncached_memalloc(bufferlen) bbu_vm_malloc(bufferlen,NON_CACHEABLE)
#define USB_memfree               bbu_vm_free
