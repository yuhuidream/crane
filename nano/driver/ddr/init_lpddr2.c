...
//enable 4to1 phy mode
 ...
 // intial lpddr2 here for MCK6+DFI phy (533Mhz)
  //MCK6 module
  REG32(DDRC_BASE+0x0044) = 0x00030200; //MC_Control_0
  REG32(DDRC_BASE+0x0058) = 0x0000011E;  
  REG32(DDRC_BASE+0x005c) = 0x000494e4; 
  REG32(DDRC_BASE+0x0048) = 0x00000001; //MC_excu_en
  REG32(DDRC_BASE+0x0180) = 0x00010200; 
  REG32(DDRC_BASE+0x0050) = 0x000000ff; 
...
// low for 533 
  ...
  REG32(DDRC_BASE+MC_CH0_BASE+0x100) = 0x00000004;  //DRAM Config 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x10c) = 0x00000050;
  REG32(DDRC_BASE+MC_CH0_BASE+0x110) = 0x00000000;
 //REG32(DDRC_BASE+MC_CH0_BASE+0x114) = 0x00000000;
  ...
  #endif
  REG32(DDRC_BASE+MC_CH0_BASE+0x18c) = 0x000E010B;  //ZQC timing 0
  REG32(DDRC_BASE+MC_CH0_BASE+0x190) = 0x00190061;  //ZQC timing 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x194) = 0x0011001A;  //Refresh timing 
  //REG32(DDRC_BASE+MC_CH0_BASE+0x198) = 0x001c001c;  //SelfRefresh timing 0
  REG32(DDRC_BASE+MC_CH0_BASE+0x198) = 0x00260026;  //SelfRefresh timing 0
  //REG32(DDRC_BASE+MC_CH0_BASE+0x19c) = 0x00000A0A;  //SelfRefresh timing 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x19c) = 0x00000505;  //SelfRefresh timing 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x1a0) = 0x01050303;  //Power down timing 0
  REG32(DDRC_BASE+MC_CH0_BASE+0x1a4) = 0x00000001;  //Power down timing 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x1a8) = 0x00000205;  //MRS timing
  REG32(DDRC_BASE+MC_CH0_BASE+0x1ac) = 0x0E11050C;  //ACT timing
  REG32(DDRC_BASE+MC_CH0_BASE+0x1b0) = 0x06050305;  //Pre-Charge timing
  REG32(DDRC_BASE+MC_CH0_BASE+0x1b4) = 0x04000300;  //CAS/RAS timing 0
  REG32(DDRC_BASE+MC_CH0_BASE+0x1b8) = 0x00000300;  //CAS/RAS timing 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x1d8) = 0x025a812d;  
  REG32(DDRC_BASE+MC_CH0_BASE+0x1bc) = 0x02020404;  //Off-spec timing 0
  REG32(DDRC_BASE+MC_CH0_BASE+0x1c0) = 0x00000002;  //Off-spec timing 1
  REG32(DDRC_BASE+MC_CH0_BASE+0x1c4) = 0x00000001;  //DRAM_read timing
  REG32(DDRC_BASE+MC_CH0_BASE+0x1dc) = 0x41081239;  
  REG32(DDRC_BASE+MC_CH0_BASE+0x1e0) = 0x00000605;  
  REG32(DDRC_BASE+MC_CH0_BASE+0x148) = 0x00000000;  
  REG32(DDRC_BASE+MC_CH0_BASE+0x14c) = 0x00000000;  
...
// low for 533 end
 ...
 // set dfi_frequency for as same as fsp op
  ...
  REG32(DDRC_BASE+0x0064) = 0x0a040502; //RDP_Control
...
#ifdef DDR_1TO1
bbu_printf("NANO: Zebu LPDDR2 initialized, 1:1 mode\n\r");
#else
bbu_printf("NANO: Zebu LPDDR2 initialized, 2:1 mode\n\r");
#endif
}
